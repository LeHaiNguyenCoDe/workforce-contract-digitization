        ...
        <div class="p-4">
          ...
          <div class="row g-2">
            <div class="col-6">
              ...
              <h5 class="fs-13 text-center mt-2">Dọc (Vertical)</h5>
            </div>
            <div class="col-6">
              <div class="form-check card-radio">
              ...
              <h5 class="fs-13 text-center mt-2">Ngang (Horizontal)</h5>
            </div>
          </div>
            ...
            <div class="col-4">
              <div class="form-check sidebar-setting card-radio">
                ...
                <label class="form-check-label p-0 avatar-md w-100" for="sidebar-img-01">
                  <img src="@/assets/admin-panel/images/sidebar/img-1.jpg" alt="" class="avatar-md w-100 object-fit-cover" />
                </label>
              </div>
            ...
            <div class="col-4">
              <div class="form-check sidebar-setting card-radio">
                ...
                <label class="form-check-label p-0 avatar-md w-100" for="sidebar-img-02">
                  <img src="@/assets/admin-panel/images/sidebar/img-2.jpg" alt="" class="avatar-md w-100 object-fit-cover" />
                </label>
              </div>
            ...
            <div class="col-4">
              <div class="form-check sidebar-setting card-radio">
                ...
                <label class="form-check-label p-0 avatar-md w-100" for="sidebar-img-03">
                  <img src="@/assets/admin-panel/images/sidebar/img-3.jpg" alt="" class="avatar-md w-100 object-fit-cover" />
                </label>
              </div>
            ...
            <div class="col-4">
              <div class="form-check sidebar-setting card-radio">
                ...
                <label class="form-check-label p-0 avatar-md w-100" for="sidebar-img-04">
                  <img src="@/assets/admin-panel/images/sidebar/img-4.jpg" alt="" class="avatar-md w-100 object-fit-cover" />
                </label>
              </div>
