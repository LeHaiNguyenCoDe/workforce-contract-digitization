  ...
  <div class="admin-table-wrapper flex-1 flex flex-col overflow-hidden rounded-xl border border-white/10 bg-dark-800">
    ...
    <div v-else class="flex-1 overflow-auto">
      ...
      <div v-if="!data.length" class="py-16 text-center">
        <svg v-if="emptyIcon === 'inbox'" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="mx-auto text-slate-600 mb-4">
