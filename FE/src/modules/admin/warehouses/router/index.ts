...
export const menu: MenuItem = {
  ...
  order: 35,
  children: [
    { id: 'warehouse-dashboard', label: 'admin.dashboard', to: '/admin/warehouse' },
    { id: 'warehouse-list', label: 'admin.warehouseList', to: '/admin/warehouse/list' },
    { id: 'warehouse-inventory', label: 'admin.inventory', to: '/admin/warehouse/inventory' },
    { id: 'warehouse-inbound', label: 'admin.inboundReceipts', to: '/admin/warehouse/inbound-receipts' },
    { id: 'warehouse-outbound', label: 'admin.outboundReceipts', to: '/admin/warehouse/outbound-receipts' },
    { id: 'warehouse-suppliers', label: 'admin.suppliers', to: '/admin/warehouse/suppliers' },
  ]
}
