...
Route::prefix('v1')->group(function () {
    ...
    */
    Route::group([
        ...
        // BR-SALES: Order status transitions
        Route::post('orders/{order}/confirm', [OrderController::class, 'confirmOrder']); // BR-SALES-02
        Route::post('orders/{order}/deliver', [OrderController::class, 'markDelivered']); // BR-SALES-02
        Route::post('orders/{order}/complete', [OrderController::class, 'completeOrder']); // BR-SALES-03
        Route::post('orders/{order}/cancel', [OrderController::class, 'cancelOrder']); // BR-SALES-05

        // Finance Management (BR-FIN)
        Route::get('finance/funds', [FinanceController::class, 'getFunds']);
        ...
        // Debt Management (BR-DEBT)
        Route::get('debts/receivables', [DebtController::class, 'getReceivables']);
        Route::get('debts/receivables/summary', [DebtController::class, 'getReceivableSummary']);
        Route::post('debts/receivables/{receivable}/pay', [DebtController::class, 'payReceivable']);
        Route::get('debts/payables', [DebtController::class, 'getPayables']);
        Route::get('debts/payables/summary', [DebtController::class, 'getPayableSummary']);
        Route::post('debts/payables/{payable}/pay', [DebtController::class, 'payPayable']);
        ...
        Route::put('expenses/categories/{id}', [\App\Http\Controllers\ExpenseController::class, 'updateCategory']);
        Route::delete('expenses/categories/{id}', [\App\Http\Controllers\ExpenseController::class, 'deleteCategory']);
